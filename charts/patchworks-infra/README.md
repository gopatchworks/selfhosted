...
container as Nuxt runtime config environment variables. `dashboard.*Url`
controls browser/public `NUXT_PUBLIC_*` values. `dashboard.server*Url` controls
private server-side `NUXT_*` values used during SSR.
